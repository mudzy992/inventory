...
-- Dumping database structure for sql7579268
CREATE DATABASE IF NOT EXISTS `sql7579268` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `sql7579268`;

-- Dumping structure for table sql7579268.administrator
...
-- Dumping data for table sql7579268.administrator: ~1 rows (approximately)
...
-- Dumping structure for table sql7579268.administrator_token
...
-- Dumping data for table sql7579268.administrator_token: ~85 rows (approximately)
...
-- Dumping structure for table sql7579268.article_feature
...
-- Dumping data for table sql7579268.article_feature: ~49 rows (approximately)
...
-- Dumping structure for table sql7579268.category
CREATE TABLE IF NOT EXISTS `category` (
  ...
  CONSTRAINT `FK_category_category` FOREIGN KEY (`parent__category_id`) REFERENCES `category` (`category_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table sql7579268.category: ~8 rows (approximately)
...
-- Dumping structure for table sql7579268.debt_items
CREATE TABLE IF NOT EXISTS `debt_items` (
  `debt_items_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `status` varchar(50) NOT NULL DEFAULT 'razduženo',
  `comment` varchar(250) DEFAULT NULL,
  `inv_broj` varchar(250) DEFAULT NULL,
  ...
  KEY `FK_debt_items_user` (`user_id`),
  KEY `fk_debt_items_user_article_id` (`user_article_id`),
  CONSTRAINT `fk_debt_items_article_di` FOREIGN KEY (`article_id`) REFERENCES `article` (`article_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_debt_items_document_id` FOREIGN KEY (`document_id`) REFERENCES `documents` (`documents_id`) ON UPDATE CASCADE,
  CONSTRAINT `FK_debt_items_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_debt_items_user_article_id` FOREIGN KEY (`user_article_id`) REFERENCES `user_article` (`user_article_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table sql7579268.debt_items: ~1 rows (approximately)
...
-- Dumping structure for table sql7579268.department
CREATE TABLE IF NOT EXISTS `department` (
  ...
  UNIQUE KEY `departmend_code` (`departmend_code`),
  KEY `FK_department_department` (`parent_department_id`),
  CONSTRAINT `FK_department_department` FOREIGN KEY (`parent_department_id`) REFERENCES `department` (`department_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table sql7579268.department: ~29 rows (approximately)
...
-- Dumping structure for table sql7579268.department_job
CREATE TABLE IF NOT EXISTS `department_job` (
  `department_job_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `FK_department_job_location` (`location_id`),
  CONSTRAINT `department_job_department_id` FOREIGN KEY (`department_id`) REFERENCES `department` (`department_id`) ON UPDATE CASCADE,
  CONSTRAINT `department_job_job_id` FOREIGN KEY (`job_id`) REFERENCES `job` (`job_id`) ON UPDATE CASCADE,
  CONSTRAINT `FK_department_job_location` FOREIGN KEY (`location_id`) REFERENCES `location` (`location_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table sql7579268.department_job: ~74 rows (approximately)
...
-- Dumping structure for table sql7579268.destroyed
CREATE TABLE IF NOT EXISTS `destroyed` (
  `destroyed_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_article_id` int(10) unsigned NOT NULL,
  `article_id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL,
  `document_id` int(10) unsigned NOT NULL,
  ...
  `status` varchar(250) NOT NULL DEFAULT 'otpisano',
  `comment` varchar(250) DEFAULT NULL,
  `inv_broj` varchar(250) DEFAULT NULL,
  ...
  KEY `FK_destroyed_user` (`user_id`),
  KEY `fk_destroyed_user_article_id` (`user_article_id`),
  CONSTRAINT `fk_destroyed_article_id` FOREIGN KEY (`article_id`) REFERENCES `article` (`article_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_destroyed_document_id` FOREIGN KEY (`document_id`) REFERENCES `documents` (`documents_id`) ON UPDATE CASCADE,
  CONSTRAINT `FK_destroyed_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_destroyed_user_article_id` FOREIGN KEY (`user_article_id`) REFERENCES `user_article` (`user_article_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table sql7579268.destroyed: ~0 rows (approximately)
DELETE FROM `destroyed`;

-- Dumping structure for table sql7579268.documents
CREATE TABLE IF NOT EXISTS `documents` (
  ...
  CONSTRAINT `fk_documents_article_id` FOREIGN KEY (`article_id`) REFERENCES `article` (`article_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table sql7579268.documents: ~11 rows (approximately)
...
-- Dumping structure for table sql7579268.feature
...
-- Dumping data for table sql7579268.feature: ~19 rows (approximately)
DELETE FROM `feature`;
...
-- Dumping structure for table sql7579268.job
...
-- Dumping data for table sql7579268.job: ~26 rows (approximately)
DELETE FROM `job`;
...
-- Dumping structure for table sql7579268.location
CREATE TABLE IF NOT EXISTS `location` (
  ...
  CONSTRAINT `FK_location_location` FOREIGN KEY (`parent_location_id`) REFERENCES `location` (`location_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table sql7579268.location: ~4 rows (approximately)
...
-- Dumping structure for table sql7579268.responsibility
CREATE TABLE IF NOT EXISTS `responsibility` (
  ...
  KEY `fk_responsibility_article_id` (`article_id`),
  KEY `fk_responsibility_document_id` (`document_id`),
  KEY `fk_responsibility_user_article_id` (`user_article_id`),
  CONSTRAINT `fk_responsibility_article_id` FOREIGN KEY (`article_id`) REFERENCES `article` (`article_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_responsibility_document_id` FOREIGN KEY (`document_id`) REFERENCES `documents` (`documents_id`) ON UPDATE CASCADE,
  CONSTRAINT `FK_responsibility_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_responsibility_user_article_id` FOREIGN KEY (`user_article_id`) REFERENCES `user_article` (`user_article_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table sql7579268.responsibility: ~4 rows (approximately)
...
-- Dumping structure for table sql7579268.stock
CREATE TABLE IF NOT EXISTS `stock` (
  `stock_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `article_id` int(10) unsigned NOT NULL DEFAULT '0',
  `value_on_concract` int(11) NOT NULL DEFAULT '0',
  `value_available` int(11) NOT NULL DEFAULT '0',
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `sap_number` varchar(50) NOT NULL DEFAULT '0',
  PRIMARY KEY (`stock_id`),
  KEY `fk_stock_article_id` (`article_id`),
  CONSTRAINT `fk_stock_article_id` FOREIGN KEY (`article_id`) REFERENCES `article` (`article_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table sql7579268.stock: ~12 rows (approximately)
DELETE FROM `stock`;
INSERT INTO `stock` (`stock_id`, `article_id`, `value_on_concract`, `value_available`, `timestamp`, `sap_number`) VALUES
	...
	(448, 90, 5, 1, '2022-11-19 01:24:21', '1300-100200');

-- Dumping structure for table sql7579268.upgrade_feature
CREATE TABLE IF NOT EXISTS `upgrade_feature` (
  `upgrade_feature_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `value` varchar(50) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  CONSTRAINT `upgrade_feature_article_id_article_article_id` FOREIGN KEY (`article_id`) REFERENCES `article` (`article_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table sql7579268.upgrade_feature: ~4 rows (approximately)
...
-- Dumping structure for table sql7579268.user
CREATE TABLE IF NOT EXISTS `user` (
  ...
  CONSTRAINT `fk_user_department_id` FOREIGN KEY (`department_id`) REFERENCES `department` (`department_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_user_job_id` FOREIGN KEY (`job_id`) REFERENCES `job` (`job_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_user_location_id` FOREIGN KEY (`location_id`) REFERENCES `location` (`location_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table sql7579268.user: ~39 rows (approximately)
DELETE FROM `user`;
INSERT INTO `user` (`user_id`, `surname`, `forname`, `fullname`, `local_number`, `telephone`, `email`, `password_hash`, `job_id`, `department_id`, `location_id`) VALUES
	...
	(156, 'Edin', 'Arnaut', 'Edin Arnaut', '1601', '032/449-601', 'e.arnaut@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 12, 19, 2),
	(157, 'Ahmed', 'Mutapčić', 'Ahmed Mutapčić', '1602', '032-449-602', 'a.mutapcic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 13, 19, 2),
	(158, 'Azra', 'Talić', 'Azra Talić', '1603', '032/449-603', 'a.talic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 14, 19, 2),
	(159, 'Nedžad', 'Osmanović', 'Nedžad Osmanović', '1560', '032/449-560', 'ne.osmanovic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 15, 19, 2),
	(160, 'Dženana', 'Skomorac - Kos', 'Dženana Skomorac - Kos', '1648', '032/449-648', 'dz.skomorac@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 9, 20, 2),
	(161, 'Jasmin', 'Ćatić', 'Jasmin Ćatić', '1501', '032/449-501', 'j.catic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 16, 20, 2),
	(162, 'Asaf', 'Kajmaković', 'Asaf Kajmaković', '1501', '032/449-501', 'a.kajmakovic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 16, 20, 2),
	(163, 'Raif', 'Mešić', 'Raif Mešić', '1501', '032/449-501', 'r.mesic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 16, 20, 2),
	(164, 'Halid', 'Zukić', 'Halid Zukić', '1657', '032/449-657', 'h.zukic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 9, 21, 2),
	(165, 'Goran', 'Skočilić', 'Goran Skočilić', '1556', '032/449-556', 'g.skocilic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 17, 21, 2),
	(166, 'Nermin', 'Skenderović', 'Nermin Skenderović', '1557', '032/449-557', 'n.skenderovic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 17, 21, 2),
	(167, 'Nihad', 'Kesić', 'Nihad Kesić', '1558', '032/449-558', 'n.kesic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 17, 21, 2),
	(168, 'Mirnes', 'Kaknjo', 'Mirnes Kaknjo', '1559', '032/449-559', 'm.kaknjo@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 17, 21, 2),
	(169, 'Enes', 'Krdžalić', 'Enes Krdžalić', '1612', '032/449-612', 'e.krdzalic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 18, 34, 2),
	(170, 'Edin', 'Kovač', 'Edin Kovač', '1612', '032/449-612', 'e.kovac@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 19, 34, 2),
	(171, 'Adnan', 'Ibreljić', 'Adnan Ibreljić', '1658', '032/449-658', 'a.ibreljic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 20, 34, 2),
	(172, 'Ernes', 'Bedak', 'Ernes Bedak', '1611', '032/449-611', 'e.bedak@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 9, 6, 2),
	(173, 'Armin', 'Bašić', 'Armin Bašić', '1611', '032/449-611', 'ar.basic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 21, 6, 2),
	(174, 'Mirha', 'Ćatić', 'Mirha Ćatić', '1615', '032/449-615', 'm.catic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 10, 6, 2),
	(175, 'Mirha', 'Bašić', 'Mirha Bašić', '1614', '032/449-614', 'mirha.basic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 11, 6, 2),
	(176, 'Mirsad', 'Bečić', 'Mirsad Bečić', '1610', '032/449-610', 'm.becic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 9, 7, 2),
	(177, 'Adis', 'Redžepović', 'Adis Redžepović', '1697', '032/449-697', 'a.redzepovic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 22, 7, 2),
	(178, 'Amina', 'Kavazovic', 'Amina Kavazović', '1694', '032/449-694', 'a.kavazovic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 23, 7, 2),
	(179, 'Jasmina', 'Karić', 'Jasmina Karić', '1607', '032/449-607', 'j.cucukovic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 24, 7, 2),
	(180, 'Armin', 'Maličbegović', 'Armin Maličbegović', '1609', '032/449-609', 'a.mlicbegovic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 25, 7, 2),
	(181, 'Mirhat', 'Đuherić', 'Mirhat Đuherić', '1677', '032/449-677', 'm.dzuheric@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 26, 7, 2),
	(182, 'Rukija', 'Huseinspahić', 'Rukija Huseinspahić', '1622', '032/449-622', 'r.huseinspahic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 27, 7, 2),
	(183, 'Amra', 'Imamović', 'Amra Imamović', '1678', '032/449-678', 'am.imamovic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 9, 8, 2),
	(184, 'Sead', 'Kratina', 'Sead Kratina', '1606', '032/449-606', 's.kratina@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 28, 9, 2),
	(185, 'Smaragda', 'Imamović', 'Smaragda Imamović', '1606', '032/449-606', 's.imamovic@epbih.ba', 'A5DFA812369F37FFD1755CA396C471CCEBC16B19DAEC09A1442287BCE01BD2BDC7603A2B86DF587FDAFA3EDEF4DA3E9D76E8B8194D24E696DCCA329CDD1429DE', 29, 9, 2),
	(186, 'Benjamin', 'Kovačević', 'Benjamin Kovačević', '1679', '032/449-679', 'b.kovacevuc@epbih.ba', 'D8C078577BE9F6B3F869EBF5E2E19009FFDF74C7BD3821BD6A8D0745F922E09A33C3AD3C41FEB58E5DC8B625E96CF39FF91416FDA190A362E5E9B1ABAE1AECEF', 9, 12, 2);

-- Dumping structure for table sql7579268.user_article
CREATE TABLE IF NOT EXISTS `user_article` (
  `user_article_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `article_id` int(10) unsigned NOT NULL,
  `document_id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL,
  `serial_number` varchar(250) NOT NULL,
  ...
  KEY `FK_user_article_user` (`user_id`),
...
-- Dumping data for table sql7579268.user_article: ~10 rows (approximately)
...
INSERT INTO `user_article` (`user_article_id`, `article_id`, `document_id`, `user_id`, `serial_number`, `status`, `timestamp`, `comment`, `inv_broj`) VALUES
	...
	(276, 90, 212, 148, 'KJKSZPJ', 'razduženo', '2022-11-19 00:52:54', '', 'ZE0621548'),
	(277, 90, 213, 148, 'KJKSZPJ', 'zaduženo', '2022-11-19 01:23:06', 'Zaduženje nove opreme', 'ZE0621548'),
	(278, 90, 214, 149, 'AEROZAKMI', 'zaduženo', '2022-11-19 01:24:21', 'Zaduženje nove opreme', 'ZE1264854');

-- Dumping structure for table sql7579268.user_token
...
-- Dumping data for table sql7579268.user_token: ~50 rows (approximately)
