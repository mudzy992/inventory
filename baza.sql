...
INSERT INTO `responsibility` (`responsibility_id`, `user_article_id`, `user_id`, `article_id`, `document_id`, `value`, `status`, `timestamp`, `serial_number`, `inv_broj`) VALUES
	...
	(106, 248, 1, 92, 159, 1, 'zaduženo', '2022-04-30 05:48:59', 'KJKSZPJJJ', 'ZE0689528'),
	(108, 250, 2, 96, 161, 1, 'zaduženo', '2022-04-30 06:04:08', 'MAROJE33', 'ZE0684368'),
	(109, 251, 2, 83, 162, 1, 'zaduženo', '2022-04-30 16:11:39', 'AEZAKMI', 'ZE0685859'),
	(110, 252, 6, 83, 163, 1, 'zaduženo', '2022-04-30 16:12:04', 'KLSJDOSJ', 'ZE0685860'),
	(111, 253, 7, 83, 164, 1, 'zaduženo', '2022-04-30 16:12:20', 'ASČDGAA', 'ZE0685862');
...
INSERT INTO `upgrade_feature` (`upgrade_feature_id`, `article_id`, `name`, `value`, `timestamp`, `comment`, `serial_number`) VALUES
	...
	(7, 92, 'SSD', '256GB', '2022-04-30 05:51:34', 'Ostavljen tvrdi disk 1TB, ugrađen naknadno SSD od 256GB zbog potrebe posla. Na SSD instaliran windows i potrebne aplikacije. Korisniku postavljena rola PowerUser-a', 'KJKSZPJJJ'),
	(9, 90, 'RAM', '8GB', '2022-04-30 05:55:59', 'Ugradjeno 8GB Radne memorije. Zahtjev odobrila šefica.', 'HJUG78H9S'),
	(10, 96, 'RAM', '16GB', '2022-04-30 06:02:13', 'Ugradjeno naknadno 16GB, odobreno od strane nadležnih.', 'MAROJE33'),
	(11, 96, 'SSD', '256GB', '2022-04-30 06:03:17', 'Postojeći SSD disk prestao sa radom. Ugradjen novi. Instaliran Windows i potrebne aplikacije.', 'MAROJE33'),
	(12, 90, 'SSD ', '256GB', '2022-07-12 23:21:36', 'Ugrađen SSD od 256GB, ostavljen HDD od 500GB. Urađeno detaljno čišćenje radne stanice.', 'BELAJ');
...
INSERT INTO `user_article` (`user_article_id`, `article_id`, `document_id`, `user_id`, `serial_number`, `status`, `timestamp`, `comment`, `inv_broj`) VALUES
	...
	(248, 92, 159, 1, 'KJKSZPJJJ', 'zaduženo', '2022-04-30 05:48:59', 'Zaduženje nove opreme', 'ZE0689528'),
	(249, 96, 160, 6, 'MAROJE33', 'razduženo', '2022-04-30 06:00:31', 'Prebačeno s Emira na Gorana, da vidimo da li se i nadogradnje prebacuju.', 'ZE0684368'),
	(250, 96, 161, 2, 'MAROJE33', 'zaduženo', '2022-04-30 06:04:08', 'Zaduženje nove opreme', 'ZE0684368'),
	(251, 83, 162, 2, 'AEZAKMI', 'zaduženo', '2022-04-30 16:11:39', 'Zaduženje nove opreme', 'ZE0685859'),
	(252, 83, 163, 6, 'KLSJDOSJ', 'zaduženo', '2022-04-30 16:12:04', 'Zaduženje nove opreme', 'ZE0685860'),
	(253, 83, 164, 7, 'ASČDGAA', 'zaduženo', '2022-04-30 16:12:20', 'Zaduženje nove opreme', 'ZE0685862');
